#include "worley_noise_visualization.h"
...
namespace stuff
{
	...
	void WorleyNoiseVisualization::Init()
	{
		timer_ = 0;
	...
	void WorleyNoiseVisualization::Update(float dt)
	{
		timer_ += dt;
	...
	void WorleyNoiseVisualization::Destroy()
	{
	}
}
