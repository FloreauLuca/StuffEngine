#include "cellular_automata_visualizaion.h"
...
namespace stuff
{
	...
	void CellularAutomataVisualization::Init()
	{
		timer_ = 0;
	...
	void CellularAutomataVisualization::Update(float dt)
	{
		timer_ += dt;
	...
	void CellularAutomataVisualization::Destroy()
	{
	}
}
