#include "simplex_voise_visualization.h"
...
namespace stuff
{
	...
	void SimplexNoiseVisualization::Init()
	{
		timer_ = 0;
	...
	void SimplexNoiseVisualization::Update(float dt)
	{
		timer_ += dt;
	...
	void SimplexNoiseVisualization::Destroy()
	{
	}
}
