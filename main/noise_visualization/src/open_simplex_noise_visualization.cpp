#include "open_simplex_noise_visualization.h"
...
namespace stuff
{
	...
	void OpenSimplexNoiseVisualization::Init()
	{
		timer_ = 0;
	...
	void OpenSimplexNoiseVisualization::Update(float dt)
	{
		timer_ += dt;
	...
	void OpenSimplexNoiseVisualization::Destroy()
	{
	}
}
